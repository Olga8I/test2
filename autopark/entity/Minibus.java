...
public class Minibus extends Car implements PassengerCar, CargoCar {
    ...
    public Minibus(String brand, String model, FuelType fuelType, int year, double consumption, int passengers, double cargo, BodyType bodyType) {
    ...
    @Override
    public void seal() {
        System.out.println("Sealing minibus");
    }
    ...
    public void disinfectInterior() {
        System.out.println("Disinfecting interior of the minibus");
    }
